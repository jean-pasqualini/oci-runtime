...
This describes how to handle test request.
...
To create a test.
Look at the template in templates/template-test.md
Then create a new file in .agent/requests/test/[feature-name].md
And add the test plan in it.