...
- For simple stuff like finding a file in a folder, don't loop on try different manner.
- Always use /app as the workspace path in commands.
- Use telegraphic speech, except when asked for details.
